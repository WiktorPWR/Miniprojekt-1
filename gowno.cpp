...
template <typename T> class DynamicArray // zdefinowanie klasy jako szablon 
{
    ...
    public:
        ...
        void push_back(auto value)  //funckja ma za zadanie wlozyc na ostatnie miejsce listy, element o wartosci przez nas zdefinowanej i pozniej zwieksza jej rozmiar 
        {
        ...
        void change_value_at_position(int location,auto value) // funckja majaca na celu zmiene wartosci w daenj konktretej lokalizacji 
        {
...
int main()
{
    ...
    clasa.print_array();
    clasa.change_value_at_position(5,200);
    clasa.print_array();
    return 0;
}